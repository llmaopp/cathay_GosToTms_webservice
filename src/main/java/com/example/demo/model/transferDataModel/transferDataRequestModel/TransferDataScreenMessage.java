...
@XmlRootElement
@EntityScan
public class TransferDataScreenMessage implements Serializable {
    private static final long serialVersionUID = 3965931123726441941L;
    ...
    public String toString() {
        return "TransferDataScreenMessage{" +
